...
class WeddingCheckList extends React.Component {
  ...
  />  
        ...
        <div id="hey" className="col-md-12">
          ...
          <img src={friends} alt="" />
          <div id="one" className="col-md-12">
            ...
            <input type="checkbox" name="check3" checked={this.state.check3} onChange={this.onCheckChange} /> Choose wedding party: Maid of Honor and Bridesmaids, < br />Best Man and Groomsmen, Flower Girl and Ring Bearer. <br />
